...
const Navbar = () => {
  ...
  return (
    <header className="bg-transparent border-b border-gray-700 relative">
          ...
          <div className="md:flex md:items-center md:gap-12">
            ...
            <div className="flex items-center gap-4">
              ...
              {isOpen && (
                <nav
                  ref={navRef}
                  className="fixed z-50 top-0 left-0 w-4/5 h-full bg-black/95 transition-all duration-200 ease-in-out transform translate-x-[-100%]"
                  style={{ transform: isOpen ? "translateX(0)" : "" }}
                >
                  <div className="flex flex-col h-full">
                    <ul className="flex flex-col p-8 space-y-4 text-white text-2xl">
                      <li className="px-2 pb-8">
                        <Link href="/" className="block xl:pl-2">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="1024"
                      ...
                      {[
                        ...
                        <li key={index} className="px-2">
                          <Link
                            ...
                            className={`relative text-gray-300 flex transition hover:text-gray-500/75 ${
                              isActive(link.path)
                                ? "text-white before:content-[''] before:bg-primary before:p-1 before:absolute before:rounded-full before:-left-4 before:top-3 before:transform"
                                : ""
                            }`}
                          >
                            {link.title}
              ...
              <div
                className={`fixed top-0 left-0 w-full h-full bg-black opacity-50 transition-all duration-200 ease-in-out ${
                  isOpen ? "block" : "hidden"
                }`}
              />
            </div>
